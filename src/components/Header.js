            ...
            : <>
                ...
                <div className="header__right flex items-center gap-6">
                    <div className="flag flex items-center gap-2">
                        <span className="flag-icon flag-icon-in text-2xl"></span>
                        <span className="text-gray-500 text-xl font-medium hidden sm:block">India</span>
                    </div>
                    ...
                    <div className="avatar flex items-center gap-4 ml-3 cursor-pointer">
                        <div className="avatar__info hidden sm:block">
                            <h3 className="lowercase text-gray-500 text-2xl font-medium">sammed</h3>
                            <p className="pl-6 lowercase font-normal text-gray-500 text-base">developer</p>
                        </div>
                        <img src="/images/behance.png" alt="user" className="w-16 h-16 border-0 object-cover rounded-full"/>
                    </div>
                </div>
            </>
            }
